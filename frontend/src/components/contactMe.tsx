...
export default function ContactMe() {
  ...
  return (
    <section className="contactMe--section" id="contactMe--section" ref={ref}>
      ...
      <div
        className={
          inView ? "contactMe--info showHidden" : "contactMe--info hidden"
        }
      >
        {/* <div> */}
        <h1>Contact Me</h1>
        <p>
          For questions, feedback and offers, you may reach out to me through
          the following contact information and social platforms.
        </p>
        ...
        <div
          className={
            inView
              ? "contactMe--socials showHidden"
              : "contactMe--socials hidden"
          }
        >
          <div
            className="socialBox"
      ...
      <form
        className={
          inView ? "contactMe--form showHidden" : "contactMe--form hidden"
        }
        ref={form}
        onSubmit={sendEmail}
      >
        ...
        <input
          ...
          name="contactMe--email"
          type="email"
          placeholder="Email Address"
          required
        />
        <input
          className="contactMe--subject"
          name="contactMe--subject"
          type="text"
          placeholder="Subject"
          required
        />
        <textarea
          ...
          name="contactMe--message"
          placeholder="Message"
          required
        />
        <button className={buttonDisabled ? "buttonDisabled" : "buttonEnabled"}>
          Send
        </button>
      </form>
    </section>
