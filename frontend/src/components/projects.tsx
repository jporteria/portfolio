  ...
  const projects = [
    {
      ...
      description: `NetPlease is a movie rating website aimed at providing users with a
    ...
    },
    {
      ...
      description: `This project was built using the MERN stack (MongoDB, Express, React,
    ...
    },
    {
      ...
      description: `SideNote is a note-taking web application designed to provide a
    ...
    <section className="projects--section" id="projects--section" ref={ref}>
      ...
      >
        {projects.map((project, i) => (
          <div
            key={i}
            className={inView ? "project showHidden" : "project hidden"}
          >
            <img
